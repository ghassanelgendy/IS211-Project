...
title = tk.Label(text="Welcome to our Library!", font=('Baskerville Old Face', 25), bg=bg_color, fg=fg_color)
title.pack(pady=30)
...
def update_user():
    def update_action():
        ...
        new_details = new_details_entry.get()
        # You can add the SQL update command here to update user details
        log_entries.append("User details updated")
        messagebox.showinfo("Info", "User details updated!")
    ...
    tk.Label(top, font=("Andalus", 16), text="User ID :", bg=bg_color, fg=fg_color).place(relx=0.1, rely=0.2)
    user_id_entry = tk.Entry(top, bg=btn_bg_color, font=('Helvetica', 12), fg=fg_color)
    user_id_entry.place(relx=0.5, rely=0.23)

    tk.Label(top, text="New Details: ", font=("Andalus", 16), bg=bg_color, fg=fg_color).place(relx=0.1, rely=0.4)
    new_details_entry = tk.Entry(top, bg=btn_bg_color, font=('Helvetica', 12), fg=fg_color)
    new_details_entry.place(relx=0.5, rely=0.43)
...
def update_book():
    def update_action():
        ...
        new_details = new_details_entry.get()
        # You can add the SQL update command here to update book details
        log_entries.append("Book details updated")
        messagebox.showinfo("Info", "Book details updated!")
    ...
    tk.Label(top, text="Book ID: ", font=("Andalus", 16), bg=bg_color, fg=fg_color).place(relx=0.1, rely=0.2)
    book_id_entry = tk.Entry(top, bg=btn_bg_color, font=('Helvetica', 12), fg=fg_color)
    book_id_entry.place(relx=0.5, rely=0.23)
    tk.Label(top, text="New Details: ", font=("Andalus", 16), bg=bg_color, fg=fg_color).place(relx=0.1, rely=0.4)
    new_details_entry = tk.Entry(top, bg=btn_bg_color, font=('Helvetica', 12), fg=fg_color)
    new_details_entry.place(relx=0.5, rely=0.43)
...
def show_log():
    ...
    tk.Label(top, text="Report", bg=bg_color, fg=fg_color, font=('Andalus', 24)).pack(pady=10)
...
btn_show_log = ttk.Button(root, text="Report", command=show_log)
...
btn_update_user.place(x=20, y=105 + button_height + spacing_y, width=button_width, height=button_height)
btn_add_book.place(x=20, y=105 + 2 * (button_height + spacing_y), width=button_width, height=button_height)

btn_update_book.place(x=330, y=105, width=button_width, height=button_height)
btn_show_books.place(x=330, y=105 + button_height + spacing_y, width=button_width, height=button_height)
btn_browse_books.place(x=330, y=105 + 2 * (button_height + spacing_y), width=button_width, height=button_height)
btn_show_log.place(x=20, y=105 + 3 * (button_height + spacing_y), width=button_width, height=button_height)
btn_delete_book.place(x=330, y=105 + 3 * (button_height + spacing_y), width=button_width, height=button_height)
btn_borrow_book.place(x=20, y=105 + 4 * (button_height + spacing_y), width=button_width, height=button_height)
btn_borrowed_books.place(x=330, y=105 + 4 * (button_height + spacing_y), width=button_width, height=button_height)
